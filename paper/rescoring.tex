...
\item \textbf{Test sentences seen as text in training.} 83 of the \nTest{} test sentences
  also occur, as text, in the recurrent network's training split (different recordings of
  the same sentence), a property of the benchmark's own split. They are easier (5.4\%
  first-pass WER against 8.3\% on the other 895), and excluding them leaves the conclusions
  unchanged: on the 895 unseen sentences OPT-6.7b gains 0.32 points at the published
  weight and 0.92 with it re-tuned.
